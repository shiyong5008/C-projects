...
*edit and add your response here* the trylock is very important to use to prevent totally locked out, and make the program on going to next paint. Starvation is the one of or part of threads got hogged and next got chance to paint. So if not quite well use the trylock will cause the issue.
